...
namespace GhostWriter.Infrastructure
{
    public static class MimeTypes
    {
        ...
        public static bool ProfilePictureCheckIfSupported(string mimType)
        {
            var supportedProfilePictureTypes = new List<string>() { ImageJpeg, ImagePng };

            return supportedProfilePictureTypes.Contains(mimType);
        }
