...
namespace GhostWriter.Infrastructure.Migrations
{
    ...
    [Migration("20210416114537_transaction_update")]
            ...
            modelBuilder.Entity("GhostWriter.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "56749262-8484-4025-b2da-ee27547f4e08",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "13e32ff2-fe31-49f1-95f1-8d96a6cf3582",
                            Name = "Customer",
                        ...
                        {
                            Id = 3,
                            ConcurrencyStamp = "7ddc3eec-aa93-4e9e-8d5e-dda26f92fe29",
                            Name = "Ghostwriter",
            ...
            modelBuilder.Entity("GhostWriter.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "07f3b91f-6389-486e-ae20-e08d776e2567",
                            DateCreated = new DateTime(2021, 4, 16, 11, 45, 36, 658, DateTimeKind.Utc).AddTicks(2876),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEIk9WaNLAfkWMOCDQT/vrkc1qLbiWs+5RQx8Ph5No0ZEYAFkc2Mu9WmXOn27RzTPrQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "19f1b7d3-6033-4011-90fa-ac123c3becb9",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bd3fc9a5-fcd3-45a3-b6cc-976448cef355",
                            DateCreated = new DateTime(2021, 4, 16, 11, 45, 36, 665, DateTimeKind.Utc).AddTicks(8451),
                            Email = "dasa_manic@code3profit.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "DASA_MANIC@CODE3PROFIT.COM",
                            NormalizedUserName = "DASA_MANIC@CODE3PROFIT.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEMzmQlYK9NhtXPzb4KWKXSEq/hSl0JcZe91D3QoWO3yNi0qjNUyS+/p8kuUf3Vk5qA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "058b55d2-501b-49eb-8f0e-da2d5f111c6f",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("GhostWriter.Domain.Entities.ServiceCharge", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            ChargeAmount = 20m,
                            EndDate = new DateTime(2021, 4, 16, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsDefault = false,
                            IsPercentage = false,
